...
#define STRING_CONFIG_H_AUTHOR "(Folger Tech, V3, 8-1-16)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FT-5"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // FIND YOUR OWN: "M303 E-1 S60 C8" to run autotune on the bed at 90 degreesC for 8 cycles.
#endif // PIDTEMPBED
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  // #define Y_PROBE_OFFSET_FROM_EXTRUDER -82
  //
  //    +-- BACK ---+
  //    |           |
  //  L |    (+) P  | R <-- probe (20,20)
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -78  // Y offset: -front +behind [the nozzle]
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 276 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.256,80.256,399,54}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {2500,2500,200,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          2500    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  2500    // E acceleration in mm/s^2 for retracts
